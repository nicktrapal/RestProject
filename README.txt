...
So you first need to use post requests to create new products before doing any queries.

Specifications on how to use the API are included in the API Description textfile.
